...
const FORM_EMAIL_LABEL = "Email Address"; //If you use form email collection don't care about this parameter
...
const eventRegistration = (e) => {
  ...
  //  Logger.log(event)
  var newEvent = Calendar.Events.update(event, CALENDAR_ID, event.id, {
    sendUpdates: "all",
  });
